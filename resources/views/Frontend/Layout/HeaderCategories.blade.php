...
<head>
    ...
    <script src="{{asset('front-end/isotope.pkgd.min.js')}}"></script>
...
<body>
    ...
    <section class="banner">
        <div class="container">
            <a href=""><img src="{{asset('front-end/images/banner-sach-ktkn.jpg')}}" alt="banner-sach-ktkn" class="img-fluid"></a>
        </div>
    </section>