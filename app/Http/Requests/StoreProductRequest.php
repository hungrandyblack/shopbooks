...
class StoreProductRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'quantity.required'     => "Vui lòng nhập sốlượng sản phẩm",
            'author_id.required'    => "Vui lòng tác giả của sản phẩm",
            ...
            'quantity.numeric'      => "Vui lòng nhập số lượng sản phẩm theo dạng số ",
        ];
    }
}
