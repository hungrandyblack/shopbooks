...
<head>
    ...
    <link rel="stylesheet" href="{{asset('front-end/css/gio-hang.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('front-end/lick/slick-theme.css')}}" />
...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-white navbar-light">
        <div class="container">
            <!-- logo  -->
            <a class="navbar-brand" href="{{route('home')}}" style="color: #CF111A;"><b></b>DealBook</a>
